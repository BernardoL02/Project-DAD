      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center justify-between h-16 space-x-8">
          ...
          <div class="flex-shrink-0">
            ...
            >
              <span
                class="bg-gradient-to-r from-sky-500 to-indigo-500 text-transparent bg-clip-text flex flex-row"
              >
                <img
                  src="/spade.png"
          ...
          <div
            :class="{
              'hidden lg:flex': true,
              'flex flex-col lg:flex-row lg:space-x-8  pr-8': true
            }"
          >
            <RouterLink
              to="/"
            ...
            <RouterLink
              v-if="authStore.isAdmin || authStore.isPlayer"
              :to="{ name: 'statistics' }"
              :class="[
          ...
          <div v-if="authStore.user" class="flex flex-row space-x-7">
            <div>
              ...
              >
                ...
                >
                  <div
                    class="absolute right-0 mt-2 w-[270px] bg-white border border-gray-200 rounded-lg shadow-lg"
                  ...
                  >
                    ...
                    <ul class="space-y-1 p-1 overflow-y-auto max-h-72">
                      <div class="flex flex-row justify-end mr-4">
                        <p
                          class="text-[10px] text-gray-500 hover:text-red-500 cursor-pointer transition-colors duration-300"
                        ...
                        <div>
                          ...
                          >
                            ...
                            <span v-else class="text-xs"
                              >You receive a bonus of {{ notification.coins }} coins</span
                            >
                          </div>
                          ...
                          <div
                            v-else-if="notification.type === 'Game'"
                            class="flex flex-col text-gray-500"
                          >
                            <span v-if="notification.msg" class="text-xs">
                              {{ notification.msg }}
              ...
              <div>
                <div class="relative group flex items-center space-x-6">
                  ...
                  >
                    ...
                    <RouterLink
                      to="/updateProfile"
                      class="block text-gray-900 hover:bg-sky-100 px-4 py-2 text-sm"
                    >
                      Update Profile
                    </RouterLink>
                    <RouterLink
    ...
    <div>
      <div v-if="isMenuOpen" class="lg:hidden bg-gray-100">
        <div class="space-y-4 p-4">
          ...
          <RouterLink
            v-if="!authStore.user || authStore.isPlayer"
            to="/singleplayer"
            class="block text-gray-900 hover:text-sky-600 px-3 py-2 rounded-md text-sm font-medium"
          >
            Single-Player
