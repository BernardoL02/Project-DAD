...
const tableColumns = ['Difficulty', 'Status', 'Began At', 'Total Time', 'Turns']
...
<template>
  <div class="max-w-3xl mx-auto py-8 space-y-6">
    ...
    <div
      v-if="authStore.user"
      class="bg-sky-100 p-6 rounded-xl shadow-lg flex justify-between items-center"
    >
      <div>
    ...
    <div v-if="authStore.user" class="pt-8">
      <div>
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <div
            class="grid grid-cols-1 place-items-center items-center justify-center pt-2 space-y-2"
          >
            <div class="flex items-center space-x-2 flex-row justify-center mb-5 mt-2">
              <div
                class="relative w-32 h-8 bg-gray-200 rounded-full flex items-center cursor-pointer p-1 shadow-inner transition-all duration-300"
