...
<template>
  <div class="max-w-4xl mx-auto mt-10">
    <div v-if="transactionStore.loading" class="text-center text-lg">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex justify-center items-center mb-6">
        <div class="w-80 mx-auto">
          <DatePicker v-model="transactionStore.dateRange" range format="YYYY-MM-DD" value-format="YYYY-MM-DD"
            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-sky-500 focus:border-sky-500"
            :placeholder="transactionStore.formattedDateRange" @change="transactionStore.handleDateChange" />
        </div>
      ...
      <PaginatedTable :columns="['Id', 'Date', 'Type', 'Value', 'Payment Method', 'Reference', 'Coins']"
